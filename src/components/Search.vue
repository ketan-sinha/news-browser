<template>
  <div class="w-full mx-6">
    <form v-on:submit.prevent="submitSearch">
      <input v-model.lazy="options.q" class="w-full appearance-none border-2 border-gray-400 focus:border-black max-w-sm md:max-w-3xl xl:max-w-6xl h-12 rounded-full px-4" type="text" placeholder="Search articles..."/>
      <div class="mt-4">
        <div class="inline">
          ...
          <select class="inline text-sm p-2 ml-2 rounded-full" v-model="options.lang">
        ...
        <div class="inline ml-6">
          ...
          <select class="inline text-sm p-2 ml-2 rounded-full" v-model="options.topic">
        ...
        <div class="inline ml-6">
          <div class="inline">
            ...
            <input v-model="options.from" class="inline ml-2 text-sm p-2 rounded-full" type="date">
          </div>
          ...
          <div class="inline ml-1">
            <input v-model="options.to" class="inline text-sm p-2 rounded-full" type="date">
          </div>
        </div>
      </div>
    </form>
